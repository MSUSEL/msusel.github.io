...
export default function define(runtime, observer) {
  ...
  const fileAttachments = new Map([["sample@17.json",new URL("./files/befc30c30665eeb42fccaa8152d13ff433c778187e00117db7031aef054cb00e2b07331c46fb4665eb52d9619d971fd4f581f2cfed8fc7f7f8cf3adbbbe71842",import.meta.url)]]);
  main.builtin("FileAttachment", runtime.fileAttachments(name => fileAttachments.get(name)));
  main.variable(observer()).define(["md"], function(md){return(
md`# Software Quality Weights and Scores
...
FileAttachment("sample@17.json").json()
)});
